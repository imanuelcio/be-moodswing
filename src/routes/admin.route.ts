...
admin.get(
  "/clients",
  adminController.getConnectedClients.bind(adminController)
);

// Outbox management
admin.get(
  "/outbox/events",
  adminController.getOutboxEvents.bind(adminController)
);
admin.post(
  "/outbox/retry",
  adminController.retryFailedEvents.bind(adminController)
);
admin.post(
  "/outbox/purge",
  adminController.purgeOldEvents.bind(adminController)
);
