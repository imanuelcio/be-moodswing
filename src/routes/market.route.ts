...
market.get(
  "/public/slug/:slug",
  marketController.getMarketBySlug.bind(marketController)
);
market.get(
  "/public/:marketId/outcomes",
  outcomeController.listOutcomes.bind(outcomeController)
);
market.get(
  "/public/outcomes/:id",
  outcomeController.getOutcome.bind(outcomeController)
);
...
market.post(
  "/:marketId/outcomes",
  outcomeController.createOutcome.bind(outcomeController)
);
market.put(
  "/:marketId/outcomes/:id",
  outcomeController.updateOutcome.bind(outcomeController)
);
market.delete(
  "/:marketId/outcomes/:id",
  outcomeController.deleteOutcome.bind(outcomeController)
);
