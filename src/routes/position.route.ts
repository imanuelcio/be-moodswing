...
position.get(
  ...
  positionController.getMarketPositions.bind(positionController)
);
position.get(
  "/public/stats",
...
position.get(
  "/me",
  positionController.getUserPositions.bind(positionController)
);
position.get("/:id", positionController.getPosition.bind(positionController));
position.post(
  "/:id/close",
  positionController.closePosition.bind(positionController)
);
