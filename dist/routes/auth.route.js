...
import { createJwtMiddleware, createApiKeyMiddleware, } from "../middleware/auth.middleware.js";
const auth = new Hono();
...
auth.delete("/api-keys/:keyId", authController.revokeApiKey.bind(authController));
export { auth };
