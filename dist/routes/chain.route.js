...
chain.put("/admin/chains/:id", chainController.updateChain.bind(chainController));
chain.delete("/admin/chains/:id", chainController.deleteChain.bind(chainController));
export { chain };
