...
ws.post("/admin/notify/:userId", wsController.sendUserNotification.bind(wsController));
ws.post("/admin/broadcast/:topic", wsController.broadcastToTopic.bind(wsController));
export { ws };
