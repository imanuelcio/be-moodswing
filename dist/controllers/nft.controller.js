import { z } from "zod";
import { NftService, MintRecordSchema, CreateCollectionSchema, ListTokensQuerySchema, } from "../services/nft.service.js";
export class NftController {
    static async listCollections(c) {
        try {
    ...
    static async createCollection(c) {
        try {
            const raw = await c.req.json();
