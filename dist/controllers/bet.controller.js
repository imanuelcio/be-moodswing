...
export class BetController {
    ...
    async placeBet(c) {
        try {
            ...
            const request = placeBetSchema.parse(body);
    ...
    async listBets(c) {
        try {
            ...
            const { user_id, market_id, outcome_id, status, side, created_after, created_before, page, limit, order_by, order_dir, } = params;
