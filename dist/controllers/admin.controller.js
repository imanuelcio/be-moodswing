...
export class AdminController {
    outboxRepo;
    outboxWorker;
    constructor(outboxRepo = new OutboxRepository(), outboxWorker = new OutboxWorker()) {
        this.outboxRepo = outboxRepo;
        this.outboxWorker = outboxWorker;
    }
    async getSystemStats(c) {
        try {
