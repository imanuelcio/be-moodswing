...
export class PositionController {
    positionService;
    constructor(positionService = new PositionService()) {
        this.positionService = positionService;
    }
    async getUserPositions(c) {
        try {
    ...
    async getPosition(c) {
        try {
            ...
            const position = await this.positionService.getPosition(positionId, userId);
    ...
    async closePosition(c) {
        try {
            ...
            const result = await this.positionService.closePosition(positionId, userId, {
                quantity,
                price,
            });
            const logger = c.get("logger");
